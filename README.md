[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?branch=develop&project=inji_vc-verifier&metric=alert_status)](https://sonarcloud.io/dashboard?branch=develop&id=inji_vc-verifier)
# vc-verifier
